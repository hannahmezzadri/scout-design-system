...
`,b="--connex",j=document.documentElement,P=document.getElementById("theme"),U=document.getElementById("density"),O=document.getElementById("brand");P.addEventListener("change",()=>j.setAttribute("data-theme",P.value));U.addEventListener("change",()=>j.setAttribute("data-density",U.value));O.addEventListener("change",()=>j.setAttribute("data-brand",O.value));function L(e){return getComputedStyle(j).getPropertyValue(`${b}-${e}`).trim()}function o(e,n={},...l){const s=document.createElement(e);for(const[a,t]of Object.entries(n))a==="class"?s.className=t:a==="style"?s.setAttribute("style",t):s.setAttribute(a,t);for(const a of l)s.append(typeof a=="string"?document.createTextNode(a):a);return s}function w(e,...n){return o("section",{id:e,class:"page","data-page":e},...n)}function Z(e,n){return o("div",{class:"page-header"},o("h2",{},e),o("p",{class:"lede"},n))}function y(e,n){return o("div",{class:"category-banner"},o("h1",{},e),o("p",{},n))}function f(e,n){return o("div",{class:"empty-panel"},o("span",{class:"badge"},"Coming soon"),o("h3",{},e),o("p",{},n))}function k(e,n){const l=L(e);return o("div",{class:"swatch"},o("div",{class:"chip",style:`background: var(${b}-${e})`}),o("div",{class:"meta"},o("span",{class:"name"},n),o("span",{class:"value"},l||"—")))}function C(e){return o("h3",{class:"subheading"},e)}const p=document.getElementById("app");{const e=o("div",{class:"foundation-grid"});e.append(o("div",{class:"foundation-card"},o("h4",{},"Tiered architecture"),o("p",{},"Three tiers: Core (tokens, primitives, foundational components), Shared (cross-product patterns and page templates), Product (product-scoped patterns that can be promoted upward).")),o("div",{class:"foundation-card"},o("h4",{},"Tokens as the source of truth"),o("p",{},"Every visual property — color, typography, spacing, motion — is a token. Components consume tokens via CSS custom properties. No hard-coded values.")),o("div",{class:"foundation-card"},o("h4",{},"Web Components"),o("p",{},"Built with Lit and Shadow DOM. Framework-agnostic at the core, with ergonomic React (and later Vue, Angular) wrappers."))),p.append(w("foundation-overview",y("Foundation","The principles, theming model, and accessibility baseline that every Connex token, component, and pattern is built on."),Z("Architecture","Connex is structured as a private monorepo. Each package versions independently and ships to a private npm registry."),e))}{const e=o("div",{class:"foundation-grid"});e.append(o("div",{class:"foundation-card"},o("h4",{},"[data-theme]"),o("p",{},"light · dark — semantic color tokens flip; primitives stay constant.")),o("div",{class:"foundation-card"},o("h4",{},"[data-density]"),o("p",{},"default · condensed — typography line-heights and (later) component padding tighten for dense UIs.")),o("div",{class:"foundation-card"},o("h4",{},"[data-brand]"),o("p",{},"connex · empath · sage · onecomm · athena · graffiti · hubble · voyant · echo · e4a — brand color slots scope per product."))),p.append(w("foundation-theming",Z("Theming","Themes are scoped via data attributes on any element (typically <html>). Switching theme/density/brand is a single attribute change — no rebundle, no FOUC."),e))}p.append(w("foundation-density",Z("Density","Default vs. condensed. Condensed tightens typography line-heights so data-dense interfaces (agent desktops, tables) read more compactly without losing legibility.")));p.append(w("foundation-accessibility",Z("Accessibility","WCAG 2.1 AA is the baseline for color contrast, focus indicators, keyboard navigation, and screen-reader semantics. Components honor `prefers-reduced-motion`. Logical CSS properties (margin-inline, padding-block) are used throughout for future RTL support.")));p.append(w("foundation-motion-principles",Z("Motion principles","Motion is purposeful: enter motion decelerates (eases the user in), exit motion accelerates (gets out of the way), hover/focus is fast (≤150ms). Every animated component honors `prefers-reduced-motion: reduce` by collapsing durations to 0.")));p.append(w("tokens-overview",y("Tokens","The atomic visual values of Connex. Three layers: primitives (raw values), semantic (purposeful aliases), composite (component-level token bundles).")));{const e=w("colors",Z("Colors","Primitive color scales (100 lightest → 800 darkest), alpha overlays for scrims, plus white and black anchors.")),n=["red","orange","yellow","green","blue","purple","gray"];for(const t of n){e.append(C(t.charAt(0).toUpperCase()+t.slice(1)));const r=o("div",{class:"grid dense"});for(const g of["100","200","300","400","500","600","700","800"])r.append(k(`color-${t}-${g}`,`${t}.${g}`));e.append(r)}e.append(C("Alpha (black-based scrims)"));const l=o("div",{class:"grid dense"});for(const t of["100","200","300","400","500","600","700","800"])l.append(k(`color-alpha-${t}`,`alpha.${t}`));e.append(l),e.append(C("Alpha-white (for dark surfaces)"));const s=o("div",{class:"grid dense"});for(const t of["100","200","300","400","500","600","700","800"])s.append(k(`color-alpha-white-${t}`,`alpha-white.${t}`));e.append(s),e.append(C("Anchors"));const a=o("div",{class:"grid dense"});a.append(k("color-white","white")),a.append(k("color-black","black")),e.append(a),p.append(e)}{const e=w("brand",Z("Brand","Per-product brand colors, scoped via [data-brand]. Switch the Brand control above to see the active set update.")),n=[["connex",["light","primary","dark"]],["empath",["primary","accent"]],["sage",["primary","cream"]]];for(const[l,s]of n){e.append(C(l.charAt(0).toUpperCase()+l.slice(1)));const a=o("div",{class:"grid"});for(const t of s){const r=document.createElement("div");r.setAttribute("data-brand",l),document.body.append(r);const g=getComputedStyle(r).getPropertyValue(`${b}-brand-${l}-${t}`).trim();r.remove(),a.append(o("div",{class:"swatch"},o("div",{class:"chip",style:`background: ${g}`}),o("div",{class:"meta"},o("span",{class:"name"},`${l}.${t}`),o("span",{class:"value"},g||"—"))))}e.append(a)}p.append(e)}{const e=w("typography",Z("Typography","Composite typography tokens. Literata for heading + display, Inter for everything else. Toggle Density to compare default vs. condensed.")),n=[["display-large","t-display-large","The agent desktop loads."],["display-small","t-display-small","Connex powers Empath."],["heading-1","t-h1","Account overview"],["heading-2","t-h2","Recent transactions"],["heading-3","t-h3","Pending actions"],["heading-4","t-h4","Customer details"],["heading-5","t-h5","Section label"],["body-large","t-body-large","Larger body text for emphasized paragraphs."],["body","t-body","Body text for the main content of the page."],["body-small","t-body-small","Smaller body text for tables and condensed contexts."],["label","t-label","INPUT LABEL"],["caption","t-caption","Caption for footnotes, helper text, and metadata."]];for(const[l,s,a]of n)e.append(o("div",{class:"specimen"},o("div",{class:"meta"},o("span",{class:"key"},l),o("span",{class:"key"},`var(${b}-typography-${l}-*)`)),o("div",{class:s},a)));p.append(e)}{let e=function(i,h){const u=document.createElement("div");u.innerHTML=i;const A=u.querySelector("svg");return A?(A.removeAttribute("class"),A.removeAttribute("data-slot"),A.setAttribute("aria-hidden","true"),A.setAttribute("width",String(h)),A.setAttribute("height",String(h)),A):null},n=function(i,h,u,A){const T=a[h][i],G=u??r[h],z=o("div",{class:"icon-stage"});if(T){const D=e(T,G);D&&z.append(D)}else z.append(document.createTextNode("—"));return o("div",{class:"icon-cell",title:i},z,o("span",{class:"icon-name"},A??i))},l=function(){const i=x.value.trim().toLowerCase(),h=i?t.filter(u=>u.includes(i)):t;M.textContent=`${h.length} of ${t.length} icons`,H.replaceChildren(...h.map(u=>n(u,B))),h.length===0&&H.replaceChildren(o("div",{class:"icon-empty"},"No icons match that search."))};const s={outline:Object.assign({"../node_modules/heroicons/24/outline/academic-cap.svg":K,"../node_modules/heroicons/24/outline/adjustments-horizontal.svg":Y,"../node_modules/heroicons/24/outline/adjustments-vertical.svg":X,"../node_modules/heroicons/24/outline/archive-box-arrow-down.svg":J,"../node_modules/heroicons/24/outline/archive-box-x-mark.svg":Q,"../node_modules/heroicons/24/outline/archive-box.svg":o0,"../node_modules/heroicons/24/outline/arrow-down-circle.svg":e0,"../node_modules/heroicons/24/outline/arrow-down-left.svg":n0,"../node_modules/heroicons/24/outline/arrow-down-on-square-stack.svg":l0,"../node_modules/heroicons/24/outline/arrow-down-on-square.svg":a0,"../node_modules/heroicons/24/outline/arrow-down-right.svg":t0,"../node_modules/heroicons/24/outline/arrow-down-tray.svg":s0,"../node_modules/heroicons/24/outline/arrow-down.svg":r0,"../node_modules/heroicons/24/outline/arrow-left-circle.svg":i0,"../node_modules/heroicons/24/outline/arrow-left-end-on-rectangle.svg":d0,"../node_modules/heroicons/24/outline/arrow-left-on-rectangle.svg":v0,"../node_modules/heroicons/24/outline/arrow-left-start-on-rectangle.svg":c0,"../node_modules/heroicons/24/outline/arrow-left.svg":h0,"../node_modules/heroicons/24/outline/arrow-long-down.svg":g0,"../node_modules/heroicons/24/outline/arrow-long-left.svg":_0,"../node_modules/heroicons/24/outline/arrow-long-right.svg":u0,"../node_modules/heroicons/24/outline/arrow-long-up.svg":w0,"../node_modules/heroicons/24/outline/arrow-path-rounded-square.svg":p0,"../node_modules/heroicons/24/outline/arrow-path.svg":m0,"../node_modules/heroicons/24/outline/arrow-right-circle.svg":Z0,"../node_modules/heroicons/24/outline/arrow-right-end-on-rectangle.svg":x0,"../node_modules/heroicons/24/outline/arrow-right-on-rectangle.svg":M0,"../node_modules/heroicons/24/outline/arrow-right-start-on-rectangle.svg":f0,"../node_modules/heroicons/24/outline/arrow-right.svg":b0,"../node_modules/heroicons/24/outline/arrow-small-down.svg":A0,"../node_modules/heroicons/24/outline/arrow-small-left.svg":k0,"../node_modules/heroicons/24/outline/arrow-small-right.svg":C0,"../node_modules/heroicons/24/outline/arrow-small-up.svg":H0,"../node_modules/heroicons/24/outline/arrow-top-right-on-square.svg":V0,"../node_modules/heroicons/24/outline/arrow-trending-down.svg":B0,"../node_modules/heroicons/24/outline/arrow-trending-up.svg":L0,"../node_modules/heroicons/24/outline/arrow-turn-down-left.svg":y0,"../node_modules/heroicons/24/outline/arrow-turn-down-right.svg":j0,"../node_modules/heroicons/24/outline/arrow-turn-left-down.svg":S0,"../node_modules/heroicons/24/outline/arrow-turn-left-up.svg":q0,"../node_modules/heroicons/24/outline/arrow-turn-right-down.svg":$0,"../node_modules/heroicons/24/outline/arrow-turn-right-up.svg":z0,"../node_modules/heroicons/24/outline/arrow-turn-up-left.svg":E0,"../node_modules/heroicons/24/outline/arrow-turn-up-right.svg":I0,"../node_modules/heroicons/24/outline/arrow-up-circle.svg":T0,"../node_modules/heroicons/24/outline/arrow-up-left.svg":D0,"../node_modules/heroicons/24/outline/arrow-up-on-square-stack.svg":P0,"../node_modules/heroicons/24/outline/arrow-up-on-square.svg":U0,"../node_modules/heroicons/24/outline/arrow-up-right.svg":O0,"../node_modules/heroicons/24/outline/arrow-up-tray.svg":F0,"../node_modules/heroicons/24/outline/arrow-up.svg":R0,"../node_modules/heroicons/24/outline/arrow-uturn-down.svg":N0,"../node_modules/heroicons/24/outline/arrow-uturn-left.svg":W0,"../node_modules/heroicons/24/outline/arrow-uturn-right.svg":G0,"../node_modules/heroicons/24/outline/arrow-uturn-up.svg":K0,"../node_modules/heroicons/24/outline/arrows-pointing-in.svg":Y0,"../node_modules/heroicons/24/outline/arrows-pointing-out.svg":X0,"../node_modules/heroicons/24/outline/arrows-right-left.svg":J0,"../node_modules/heroicons/24/outline/arrows-up-down.svg":Q0,"../node_modules/heroicons/24/outline/at-symbol.svg":o5,"../node_modules/heroicons/24/outline/backspace.svg":e5,"../node_modules/heroicons/24/outline/backward.svg":n5,"../node_modules/heroicons/24/outline/banknotes.svg":l5,"../node_modules/heroicons/24/outline/bars-2.svg":a5,"../node_modules/heroicons/24/outline/bars-3-bottom-left.svg":t5,"../node_modules/heroicons/24/outline/bars-3-bottom-right.svg":s5,"../node_modules/heroicons/24/outline/bars-3-center-left.svg":r5,"../node_modules/heroicons/24/outline/bars-3.svg":i5,"../node_modules/heroicons/24/outline/bars-4.svg":d5,"../node_modules/heroicons/24/outline/bars-arrow-down.svg":v5,"../node_modules/heroicons/24/outline/bars-arrow-up.svg":c5,"../node_modules/heroicons/24/outline/battery-0.svg":h5,"../node_modules/heroicons/24/outline/battery-100.svg":g5,"../node_modules/heroicons/24/outline/battery-50.svg":_5,"../node_modules/heroicons/24/outline/beaker.svg":u5,"../node_modules/heroicons/24/outline/bell-alert.svg":w5,"../node_modules/heroicons/24/outline/bell-slash.svg":p5,"../node_modules/heroicons/24/outline/bell-snooze.svg":m5,"../node_modules/heroicons/24/outline/bell.svg":Z5,"../node_modules/heroicons/24/outline/bold.svg":x5,"../node_modules/heroicons/24/outline/bolt-slash.svg":M5,"../node_modules/heroicons/24/outline/bolt.svg":f5,"../node_modules/heroicons/24/outline/book-open.svg":b5,"../node_modules/heroicons/24/outline/bookmark-slash.svg":A5,"../node_modules/heroicons/24/outline/bookmark-square.svg":k5,"../node_modules/heroicons/24/outline/bookmark.svg":C5,"../node_modules/heroicons/24/outline/briefcase.svg":H5,"../node_modules/heroicons/24/outline/bug-ant.svg":V5,"../node_modules/heroicons/24/outline/building-library.svg":B5,"../node_modules/heroicons/24/outline/building-office-2.svg":L5,"../node_modules/heroicons/24/outline/building-office.svg":y5,"../node_modules/heroicons/24/outline/building-storefront.svg":j5,"../node_modules/heroicons/24/outline/cake.svg":S5,"../node_modules/heroicons/24/outline/calculator.svg":q5,"../node_modules/heroicons/24/outline/calendar-date-range.svg":$5,"../node_modules/heroicons/24/outline/calendar-days.svg":z5,"../node_modules/heroicons/24/outline/calendar.svg":E5,"../node_modules/heroicons/24/outline/camera.svg":I5,"../node_modules/heroicons/24/outline/chart-bar-square.svg":T5,"../node_modules/heroicons/24/outline/chart-bar.svg":D5,"../node_modules/heroicons/24/outline/chart-pie.svg":P5,"../node_modules/heroicons/24/outline/chat-bubble-bottom-center-text.svg":U5,"../node_modules/heroicons/24/outline/chat-bubble-bottom-center.svg":O5,"../node_modules/heroicons/24/outline/chat-bubble-left-ellipsis.svg":F5,"../node_modules/heroicons/24/outline/chat-bubble-left-right.svg":R5,"../node_modules/heroicons/24/outline/chat-bubble-left.svg":N5,"../node_modules/heroicons/24/outline/chat-bubble-oval-left-ellipsis.svg":W5,"../node_modules/heroicons/24/outline/chat-bubble-oval-left.svg":G5,"../node_modules/heroicons/24/outline/check-badge.svg":K5,"../node_modules/heroicons/24/outline/check-circle.svg":Y5,"../node_modules/heroicons/24/outline/check.svg":X5,"../node_modules/heroicons/24/outline/chevron-double-down.svg":J5,"../node_modules/heroicons/24/outline/chevron-double-left.svg":Q5,"../node_modules/heroicons/24/outline/chevron-double-right.svg":o1,"../node_modules/heroicons/24/outline/chevron-double-up.svg":e1,"../node_modules/heroicons/24/outline/chevron-down.svg":n1,"../node_modules/heroicons/24/outline/chevron-left.svg":l1,"../node_modules/heroicons/24/outline/chevron-right.svg":a1,"../node_modules/heroicons/24/outline/chevron-up-down.svg":t1,"../node_modules/heroicons/24/outline/chevron-up.svg":s1,"../node_modules/heroicons/24/outline/circle-stack.svg":r1,"../node_modules/heroicons/24/outline/clipboard-document-check.svg":i1,"../node_modules/heroicons/24/outline/clipboard-document-list.svg":d1,"../node_modules/heroicons/24/outline/clipboard-document.svg":v1,"../node_modules/heroicons/24/outline/clipboard.svg":c1,"../node_modules/heroicons/24/outline/clock.svg":h1,"../node_modules/heroicons/24/outline/cloud-arrow-down.svg":g1,"../node_modules/heroicons/24/outline/cloud-arrow-up.svg":_1,"../node_modules/heroicons/24/outline/cloud.svg":u1,"../node_modules/heroicons/24/outline/code-bracket-square.svg":w1,"../node_modules/heroicons/24/outline/code-bracket.svg":p1,"../node_modules/heroicons/24/outline/cog-6-tooth.svg":m1,"../node_modules/heroicons/24/outline/cog-8-tooth.svg":Z1,"../node_modules/heroicons/24/outline/cog.svg":x1,"../node_modules/heroicons/24/outline/command-line.svg":M1,"../node_modules/heroicons/24/outline/computer-desktop.svg":f1,"../node_modules/heroicons/24/outline/cpu-chip.svg":b1,"../node_modules/heroicons/24/outline/credit-card.svg":A1,"../node_modules/heroicons/24/outline/cube-transparent.svg":k1,"../node_modules/heroicons/24/outline/cube.svg":C1,"../node_modules/heroicons/24/outline/currency-bangladeshi.svg":H1,"../node_modules/heroicons/24/outline/currency-dollar.svg":V1,"../node_modules/heroicons/24/outline/currency-euro.svg":B1,"../node_modules/heroicons/24/outline/currency-pound.svg":L1,"../node_modules/heroicons/24/outline/currency-rupee.svg":y1,"../node_modules/heroicons/24/outline/currency-yen.svg":j1,"../node_modules/heroicons/24/outline/cursor-arrow-rays.svg":S1,"../node_modules/heroicons/24/outline/cursor-arrow-ripple.svg":q1,"../node_modules/heroicons/24/outline/device-phone-mobile.svg":$1,"../node_modules/heroicons/24/outline/device-tablet.svg":z1,"../node_modules/heroicons/24/outline/divide.svg":E1,"../node_modules/heroicons/24/outline/document-arrow-down.svg":I1,"../node_modules/heroicons/24/outline/document-arrow-up.svg":T1,"../node_modules/heroicons/24/outline/document-chart-bar.svg":D1,"../node_modules/heroicons/24/outline/document-check.svg":P1,"../node_modules/heroicons/24/outline/document-currency-bangladeshi.svg":U1,"../node_modules/heroicons/24/outline/document-currency-dollar.svg":O1,"../node_modules/heroicons/24/outline/document-currency-euro.svg":F1,"../node_modules/heroicons/24/outline/document-currency-pound.svg":R1,"../node_modules/heroicons/24/outline/document-currency-rupee.svg":N1,"../node_modules/heroicons/24/outline/document-currency-yen.svg":W1,"../node_modules/heroicons/24/outline/document-duplicate.svg":G1,"../node_modules/heroicons/24/outline/document-magnifying-glass.svg":K1,"../node_modules/heroicons/24/outline/document-minus.svg":Y1,"../node_modules/heroicons/24/outline/document-plus.svg":X1,"../node_modules/heroicons/24/outline/document-text.svg":J1,"../node_modules/heroicons/24/outline/document.svg":Q1,"../node_modules/heroicons/24/outline/ellipsis-horizontal-circle.svg":o2,"../node_modules/heroicons/24/outline/ellipsis-horizontal.svg":e2,"../node_modules/heroicons/24/outline/ellipsis-vertical.svg":n2,"../node_modules/heroicons/24/outline/envelope-open.svg":l2,"../node_modules/heroicons/24/outline/envelope.svg":a2,"../node_modules/heroicons/24/outline/equals.svg":t2,"../node_modules/heroicons/24/outline/exclamation-circle.svg":s2,"../node_modules/heroicons/24/outline/exclamation-triangle.svg":r2,"../node_modules/heroicons/24/outline/eye-dropper.svg":i2,"../node_modules/heroicons/24/outline/eye-slash.svg":d2,"../node_modules/heroicons/24/outline/eye.svg":v2,"../node_modules/heroicons/24/outline/face-frown.svg":c2,"../node_modules/heroicons/24/outline/face-smile.svg":h2,"../node_modules/heroicons/24/outline/film.svg":g2,"../node_modules/heroicons/24/outline/finger-print.svg":_2,"../node_modules/heroicons/24/outline/fire.svg":u2,"../node_modules/heroicons/24/outline/flag.svg":w2,"../node_modules/heroicons/24/outline/folder-arrow-down.svg":p2,"../node_modules/heroicons/24/outline/folder-minus.svg":m2,"../node_modules/heroicons/24/outline/folder-open.svg":Z2,"../node_modules/heroicons/24/outline/folder-plus.svg":x2,"../node_modules/heroicons/24/outline/folder.svg":M2,"../node_modules/heroicons/24/outline/forward.svg":f2,"../node_modules/heroicons/24/outline/funnel.svg":b2,"../node_modules/heroicons/24/outline/gif.svg":A2,"../node_modules/heroicons/24/outline/gift-top.svg":k2,"../node_modules/heroicons/24/outline/gift.svg":C2,"../node_modules/heroicons/24/outline/globe-alt.svg":H2,"../node_modules/heroicons/24/outline/globe-americas.svg":V2,"../node_modules/heroicons/24/outline/globe-asia-australia.svg":B2,"../node_modules/heroicons/24/outline/globe-europe-africa.svg":L2,"../node_modules/heroicons/24/outline/h1.svg":y2,"../node_modules/heroicons/24/outline/h2.svg":j2,"../node_modules/heroicons/24/outline/h3.svg":S2,"../node_modules/heroicons/24/outline/hand-raised.svg":q2,"../node_modules/heroicons/24/outline/hand-thumb-down.svg":$2,"../node_modules/heroicons/24/outline/hand-thumb-up.svg":z2,"../node_modules/heroicons/24/outline/hashtag.svg":E2,"../node_modules/heroicons/24/outline/heart.svg":I2,"../node_modules/heroicons/24/outline/home-modern.svg":T2,"../node_modules/heroicons/24/outline/home.svg":D2,"../node_modules/heroicons/24/outline/identification.svg":P2,"../node_modules/heroicons/24/outline/inbox-arrow-down.svg":U2,"../node_modules/heroicons/24/outline/inbox-stack.svg":O2,"../node_modules/heroicons/24/outline/inbox.svg":F2,"../node_modules/heroicons/24/outline/information-circle.svg":R2,"../node_modules/heroicons/24/outline/italic.svg":N2,"../node_modules/heroicons/24/outline/key.svg":W2,"../node_modules/heroicons/24/outline/language.svg":G2,"../node_modules/heroicons/24/outline/lifebuoy.svg":K2,"../node_modules/heroicons/24/outline/light-bulb.svg":Y2,"../node_modules/heroicons/24/outline/link-slash.svg":X2,"../node_modules/heroicons/24/outline/link.svg":J2,"../node_modules/heroicons/24/outline/list-bullet.svg":Q2,"../node_modules/heroicons/24/outline/lock-closed.svg":o7,"../node_modules/heroicons/24/outline/lock-open.svg":e7,"../node_modules/heroicons/24/outline/magnifying-glass-circle.svg":n7,"../node_modules/heroicons/24/outline/magnifying-glass-minus.svg":l7,"../node_modules/heroicons/24/outline/magnifying-glass-plus.svg":a7,"../node_modules/heroicons/24/outline/magnifying-glass.svg":t7,"../node_modules/heroicons/24/outline/map-pin.svg":s7,"../node_modules/heroicons/24/outline/map.svg":r7,"../node_modules/heroicons/24/outline/megaphone.svg":i7,"../node_modules/heroicons/24/outline/microphone.svg":d7,"../node_modules/heroicons/24/outline/minus-circle.svg":v7,"../node_modules/heroicons/24/outline/minus-small.svg":c7,"../node_modules/heroicons/24/outline/minus.svg":h7,"../node_modules/heroicons/24/outline/moon.svg":g7,"../node_modules/heroicons/24/outline/musical-note.svg":_7,"../node_modules/heroicons/24/outline/newspaper.svg":u7,"../node_modules/heroicons/24/outline/no-symbol.svg":w7,"../node_modules/heroicons/24/outline/numbered-list.svg":p7,"../node_modules/heroicons/24/outline/paint-brush.svg":m7,"../node_modules/heroicons/24/outline/paper-airplane.svg":Z7,"../node_modules/heroicons/24/outline/paper-clip.svg":x7,"../node_modules/heroicons/24/outline/pause-circle.svg":M7,"../node_modules/heroicons/24/outline/pause.svg":f7,"../node_modules/heroicons/24/outline/pencil-square.svg":b7,"../node_modules/heroicons/24/outline/pencil.svg":A7,"../node_modules/heroicons/24/outline/percent-badge.svg":k7,"../node_modules/heroicons/24/outline/phone-arrow-down-left.svg":C7,"../node_modules/heroicons/24/outline/phone-arrow-up-right.svg":H7,"../node_modules/heroicons/24/outline/phone-x-mark.svg":V7,"../node_modules/heroicons/24/outline/phone.svg":B7,"../node_modules/heroicons/24/outline/photo.svg":L7,"../node_modules/heroicons/24/outline/play-circle.svg":y7,"../node_modules/heroicons/24/outline/play-pause.svg":j7,"../node_modules/heroicons/24/outline/play.svg":S7,"../node_modules/heroicons/24/outline/plus-circle.svg":q7,"../node_modules/heroicons/24/outline/plus-small.svg":$7,"../node_modules/heroicons/24/outline/plus.svg":z7,"../node_modules/heroicons/24/outline/power.svg":E7,"../node_modules/heroicons/24/outline/presentation-chart-bar.svg":I7,"../node_modules/heroicons/24/outline/presentation-chart-line.svg":T7,"../node_modules/heroicons/24/outline/printer.svg":D7,"../node_modules/heroicons/24/outline/puzzle-piece.svg":P7,"../node_modules/heroicons/24/outline/qr-code.svg":U7,"../node_modules/heroicons/24/outline/question-mark-circle.svg":O7,"../node_modules/heroicons/24/outline/queue-list.svg":F7,"../node_modules/heroicons/24/outline/radio.svg":R7,"../node_modules/heroicons/24/outline/receipt-percent.svg":N7,"../node_modules/heroicons/24/outline/receipt-refund.svg":W7,"../node_modules/heroicons/24/outline/rectangle-group.svg":G7,"../node_modules/heroicons/24/outline/rectangle-stack.svg":K7,"../node_modules/heroicons/24/outline/rocket-launch.svg":Y7,"../node_modules/heroicons/24/outline/rss.svg":X7,"../node_modules/heroicons/24/outline/scale.svg":J7,"../node_modules/heroicons/24/outline/scissors.svg":Q7,"../node_modules/heroicons/24/outline/server-stack.svg":oo,"../node_modules/heroicons/24/outline/server.svg":eo,"../node_modules/heroicons/24/outline/share.svg":no,"../node_modules/heroicons/24/outline/shield-check.svg":lo,"../node_modules/heroicons/24/outline/shield-exclamation.svg":ao,"../node_modules/heroicons/24/outline/shopping-bag.svg":to,"../node_modules/heroicons/24/outline/shopping-cart.svg":so,"../node_modules/heroicons/24/outline/signal-slash.svg":ro,"../node_modules/heroicons/24/outline/signal.svg":io,"../node_modules/heroicons/24/outline/slash.svg":vo,"../node_modules/heroicons/24/outline/sparkles.svg":co,"../node_modules/heroicons/24/outline/speaker-wave.svg":ho,"../node_modules/heroicons/24/outline/speaker-x-mark.svg":go,"../node_modules/heroicons/24/outline/square-2-stack.svg":_o,"../node_modules/heroicons/24/outline/square-3-stack-3d.svg":uo,"../node_modules/heroicons/24/outline/squares-2x2.svg":wo,"../node_modules/heroicons/24/outline/squares-plus.svg":po,"../node_modules/heroicons/24/outline/star.svg":mo,"../node_modules/heroicons/24/outline/stop-circle.svg":Zo,"../node_modules/heroicons/24/outline/stop.svg":xo,"../node_modules/heroicons/24/outline/strikethrough.svg":Mo,"../node_modules/heroicons/24/outline/sun.svg":fo,"../node_modules/heroicons/24/outline/swatch.svg":bo,"../node_modules/heroicons/24/outline/table-cells.svg":Ao,"../node_modules/heroicons/24/outline/tag.svg":ko,"../node_modules/heroicons/24/outline/ticket.svg":Co,"../node_modules
":$g,"../node_modules/heroicons/16/solid/wallet.svg":zg,"../node_modules/heroicons/16/solid/wifi.svg":Eg,"../node_modules/heroicons/16/solid/window.svg":Ig,"../node_modules/heroicons/16/solid/wrench-screwdriver.svg":Tg,"../node_modules/heroicons/16/solid/wrench.svg":Dg,"../node_modules/heroicons/16/solid/x-circle.svg":Pg,"../node_modules/heroicons/16/solid/x-mark.svg":Ug})},a={outline:{},solid:{},mini:{},micro:{}};for(const i of Object.keys(s))for(const[h,u]of Object.entries(s[i])){const A=h.split("/").pop().replace(".svg","");a[i][A]=u}const t=Array.from(new Set([...Object.keys(a.outline),...Object.keys(a.solid),...Object.keys(a.mini),...Object.keys(a.micro)])).sort(),r={outline:24,solid:24,mini:20,micro:16},g=w("iconography",Z("Iconography","Connex uses Hero Icons (heroicons.com). Four styles are supported — Outline and Solid at 24×24, Mini at 20×20, Micro at 16×16. Icons inherit color via currentColor and re-theme automatically.")),d=[["outline","Outline · 24"],["solid","Solid · 24"],["mini","Mini · 20"],["micro","Micro · 16"]],x=o("input",{type:"search",class:"icon-search",placeholder:'Search icons (e.g. "arrow", "user", "chart")',"aria-label":"Search icons"}),c=o("div",{class:"icon-style-toggle",role:"radiogroup","aria-label":"Icon style"}),m=[];for(const[i,h]of d){const u=o("button",{type:"button",class:"icon-style-btn",role:"radio","aria-checked":i==="outline"?"true":"false","data-style":i},h);i==="outline"&&u.classList.add("active"),m.push(u),c.append(u)}const M=o("span",{class:"icon-count"}),H=o("div",{class:"icon-grid icon-grid--catalog"});let B="outline";x.addEventListener("input",l);for(const i of m)i.addEventListener("click",()=>{B=i.dataset.style;for(const h of m){const u=h===i;h.classList.toggle("active",u),h.setAttribute("aria-checked",String(u))}l()});g.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},"Catalog"),o("p",{class:"preview-block__lede"},"The full Hero Icons set, loaded from the heroicons package. Switch styles to compare the same icon across Outline, Solid, Mini, and Micro. Search by name to filter."),o("div",{class:"icon-toolbar"},x,c,M),H)),l();const $=["plus","check","x-mark","magnifying-glass","home","bell"];for(const[i,h]of d)g.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},`${h} — featured`),o("p",{class:"preview-block__lede"},i==="outline"?"Default for most UI surfaces — buttons, list rows, tabs.":i==="solid"?"Use for emphasis (active nav items, selected states) and brand surfaces.":i==="mini"?"Use inline next to body-size text and within compact controls.":"Use only when space is severely constrained (table densities, badges)."),o("div",{class:"icon-grid"},...$.map(u=>n(u,i)))));g.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},"Sizing"),o("p",{class:"preview-block__lede"},"Hero Icons ship at three native pixel sizes. Don't scale them — use the size designed for the context to keep stroke weight and detail crisp."),o("div",{class:"icon-grid icon-grid--sizing"},n("check","micro",16,"16 · micro"),n("check","mini",20,"20 · mini"),n("check","solid",24,"24 · solid"),n("check","outline",24,"24 · outline"))));const _=[["icon-display-primary","primary"],["icon-display-secondary","secondary"],["icon-display-info","info"],["icon-display-warning","warning"],["icon-display-success","success"],["icon-display-error","error"]];g.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},"Color"),o("p",{class:"preview-block__lede"},"Icons inherit color via the CSS currentColor keyword, so any color set on a parent (or on an icon-display-* semantic token) cascades automatically. Status is never conveyed by color alone."),o("div",{class:"icon-grid"},..._.map(([i,h])=>{const u=n("bell","solid",void 0,`icon.${h}`);return u.querySelector(".icon-stage").style.color=`var(${b}-${i})`,u})))),g.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},"Usage"),o("ul",{class:"guideline-list"},o("li",{},"Pair icons with text labels whenever possible. Icon-only controls require an aria-label."),o("li",{},`Decorative icons sit alongside text and are marked aria-hidden="true" so they're not announced.`),o("li",{},"Use Outline as the default style. Reserve Solid for emphasis (active state, brand moments)."),o("li",{},"Match icon size to surrounding text size: 16 with body-small, 20 with body, 24 with body-large or as standalone affordance."),o("li",{},"Don't recolor an icon to imply a different status — use the matching icon-display-* semantic token."),o("li",{},"Source icons from heroicons.com only. Custom icons need design-system review and live in @connex/icons.")))),p.append(g)}{const e=w("spacing",Z("Spacing","4-based scale. Use these for padding, margin, gap."));for(const n of["0","4","8","12","16","24","32","48","64","96"])e.append(o("div",{class:"space-row"},o("div",{class:"label"},`space.${n}`),o("div",{class:"bar",style:`width: var(${b}-space-${n})`}),o("div",{class:"value"},L(`space-${n}`)||"0px")));p.append(e)}{const e=w("radius",Z("Corner radius","Border-radius scale. 999 = fully rounded (pill / circle).")),n=o("div",{class:"grid"});for(const l of["0","2","4","8","12","999"])n.append(o("div",{class:"radius-row"},o("div",{class:"box",style:`border-radius: var(${b}-radius-${l})`}),o("span",{class:"name"},`radius.${l}`),o("span",{class:"value"},L(`radius-${l}`))));e.append(n),p.append(e)}{const e=w("border",Z("Border width","Border thickness scale.")),n=o("div",{class:"grid"});for(const l of["0","1","2"])n.append(o("div",{class:"radius-row border-row"},o("div",{class:"box",style:`border-width: var(${b}-border-width-${l})`}),o("span",{class:"name"},`border-width.${l}`),o("span",{class:"value"},L(`border-width-${l}`))));e.append(n),p.append(e)}{const e=w("elevation",Z("Elevation","Box-shadow tokens. Levels 1–4 increase in depth.")),n=o("div",{class:"grid"});for(const l of["1","2","3","4"])n.append(o("div",{class:"elev-card",style:`box-shadow: var(${b}-elevation-${l})`},o("span",{class:"name"},`elevation.${l}`),o("span",{class:"value"},`var(${b}-elevation-${l})`)));e.append(n),p.append(e)}{const e=w("motion",Z("Motion","Hover any card to play the duration × easing combo. Reduced-motion preferences are honored at the component level when shipped.")),n=["fast","base","slow","deliberate"],l=["standard","enter","exit","emphasis"],s=o("div",{class:"motion-grid"});for(const a of n)for(const t of l)s.append(o("div",{class:"motion-card",style:`--motion-duration: var(${b}-motion-duration-${a}); --motion-ease: var(${b}-motion-easing-${t})`},o("span",{class:"name"},`${a} · ${t}`),o("span",{class:"value"},`${L(`motion-duration-${a}`)} · ${t}`),o("div",{class:"ball"})));e.append(s),p.append(e)}{const e=w("z-index",Z("Z-index","Stacking layers. Higher tokens always render above lower tokens.")),n=o("div",{class:"z-stack"});[["base (0)",16,16],["raised (10)",40,40],["sticky (100)",64,64],["overlay (1000)",88,88],["modal (2000)",112,112],["contextual (5000)",136,136],["dynamic (9000)",160,160]].forEach(([s,a,t],r)=>{n.append(o("div",{class:"layer",style:`top: ${a}px; left: ${t}px; z-index: ${r}`},s))}),e.append(n),p.append(e)}{const e=w("semantic",Z("Semantic","Aliases that components consume. Switch theme/density above to watch them shift."));e.append(C("Text — display"));const n=o("div",{class:"grid"});for(const r of["primary","secondary","info","warning","error","success","increase","decrease"])n.append(k(`text-display-${r}`,`text.display.${r}`));e.append(n),e.append(C("Text — interactive"));const l=o("div",{class:"grid"});for(const r of["primary","secondary","info","warning","error","success","increase","decrease"])l.append(k(`text-interactive-${r}`,`text.interactive.${r}`));e.append(l),e.append(C("Icon — display"));const s=o("div",{class:"grid"});for(const r of["primary","secondary","info","warning","error","success","increase","decrease"])s.append(k(`icon-display-${r}`,`icon.display.${r}`));e.append(s),e.append(C("Border"));const a=o("div",{class:"grid"});for(const r of["primary","secondary","knockout","info","warning","error","success"])a.append(k(`border-color-${r}`,`border-color.${r}`));e.append(a),e.append(C("Background"));const t=o("div",{class:"grid"});for(const r of["page","surface","scrim"])t.append(k(`background-${r}`,`background.${r}`));e.append(t),p.append(e)}function Og(e,n,l,s){const a=o("div",{class:"component-tabs",role:"tablist","aria-label":`${n} sections`}),t=o("div",{class:"component-panels"});s.forEach((d,x)=>{const c=x===0,m=o("button",{type:"button",class:`component-tab${c?" active":""}`,role:"tab",id:`tab-${e}-${d.id}`,"aria-controls":`panel-${e}-${d.id}`,"aria-selected":c?"true":"false",tabindex:c?"0":"-1"},d.label);a.append(m);const M=o("div",{class:`component-panel${c?" active":""}`,role:"tabpanel",id:`panel-${e}-${d.id}`,"aria-labelledby":`tab-${e}-${d.id}`,tabindex:"0"},d.content);t.append(M)});const r=Array.from(a.querySelectorAll(".component-tab")),g=Array.from(t.querySelectorAll(".component-panel"));return r.forEach((d,x)=>{d.addEventListener("click",()=>{r.forEach((c,m)=>{const M=m===x;c.classList.toggle("active",M),c.setAttribute("aria-selected",String(M)),c.setAttribute("tabindex",M?"0":"-1")}),g.forEach((c,m)=>c.classList.toggle("active",m===x))}),d.addEventListener("keydown",c=>{var M,H;if(c.key!=="ArrowRight"&&c.key!=="ArrowLeft")return;c.preventDefault();const m=(x+(c.key==="ArrowRight"?1:-1)+r.length)%r.length;(M=r[m])==null||M.focus(),(H=r[m])==null||H.click()})}),w(e,o("div",{class:"component-page-header"},o("span",{class:"component-eyebrow"},"Component"),o("h1",{class:"component-title"},n),o("p",{class:"component-description"},l)),a,t)}function v(e={}){const{variant:n="primary",size:l="md",label:s="Button",disabled:a=!1,loading:t=!1,leadingIcon:r,trailingIcon:g}=e,d=o("button",{type:"button",class:`cnx-btn cnx-btn--${n} cnx-btn--${l}${t?" cnx-btn--loading":""}`});return a&&d.setAttribute("disabled",""),t&&d.setAttribute("aria-busy","true"),t?d.append(o("span",{class:"cnx-btn__spinner","aria-hidden":"true"})):r&&d.append(o("span",{class:"cnx-btn__icon","aria-hidden":"true"},r)),d.append(o("span",{class:"cnx-btn__label"},s)),!t&&g&&d.append(o("span",{class:"cnx-btn__icon","aria-hidden":"true"},g)),d}function Fg(){const e=o("div",{class:"tab-content"}),n=(l,s,...a)=>{e.append(o("div",{class:"preview-block"},o("h3",{class:"preview-block__title"},l),o("p",{class:"preview-block__lede"},s),o("div",{class:"preview-row"},...a)))};return n("Variants","Four hierarchies of button. Use primary for the single most important action, secondary for supporting actions, tertiary for low-emphasis actions, and destructive for irreversible actions.",v({variant:"primary",label:"Primary"}),v({variant:"secondary",label:"Secondary"}),v({variant:"tertiary",label:"Tertiary"}),v({variant:"destructive",label:"Destructive"})),n("Sizes","Three sizes. Use medium by default. Small for dense UI like toolbars and tables; large for prominent CTAs.",v({size:"sm",label:"Small"}),v({size:"md",label:"Medium"}),v({size:"lg",label:"Large"})),n("States","States express what the button is doing or whether it can be used.",v({label:"Default"}),v({label:"Disabled",disabled:!0}),v({label:"Loading…",loading:!0})),n("With icons","Icons must be paired with a text label. Icon-only buttons require an aria-label and use a separate IconButton component (forthcoming).",v({label:"Continue",trailingIcon:"→"}),v({label:"Add",leadingIcon:"+"}),v({variant:"secondary",label:"Filter",leadingIcon:"⚲"})),e}function Rg(){const e=o("div",{class:"tab-content controls-layout"}),n=o("div",{class:"preview-stage"});function l(){n.replaceChildren(v({variant:a.value,size:t.value,label:r.value||"Button",disabled:g.checked,loading:d.checked,leadingIcon:x.checked?"+":void 0,trailingIcon:c.checked?"→":void 0})),B.textContent=s()}function s(){const _=[];return a.value!=="primary"&&_.push(`variant="${a.value}"`),t.value!=="md"&&_.push(`size="${t.value}"`),g.checked&&_.push("disabled"),d.checked&&_.push("loading"),x.checked&&_.push('leading-icon="plus"'),c.checked&&_.push('trailing-icon="arrow-right"'),`<connex-button${_.length?" "+_.join(" "):""}>${r.value||"Button"}</connex-button>`}const a=o("select",{id:"ctrl-variant"},...["primary","secondary","tertiary","destructive"].map(_=>o("option",{value:_},_.charAt(0).toUpperCase()+_.slice(1)))),t=o("select",{id:"ctrl-size"},...["sm","md","lg"].map(_=>o("option",{value:_},_.toUpperCase())));t.value="md";const r=o("input",{type:"text",id:"ctrl-label",value:"Button"}),g=o("input",{type:"checkbox",id:"ctrl-disabled"}),d=o("input",{type:"checkbox",id:"ctrl-loading"}),x=o("input",{type:"checkbox",id:"ctrl-leading"}),c=o("input",{type:"checkbox",id:"ctrl-trailing"});for(const _ of[a,t,r,g,d,x,c])_.addEventListener("input",l),_.addEventListener("change",l);const m=(_,i,h)=>o("div",{class:"ctrl-field"},o("label",{for:i},_),h),M=o("div",{class:"ctrl-checks"},o("label",{},g," Disabled"),o("label",{},d," Loading"),o("label",{},x," Leading icon"),o("label",{},c," Trailing icon")),H=o("div",{class:"ctrl-panel"},o("h3",{class:"preview-block__title"},"Properties"),m("Variant","ctrl-variant",a),m("Size","ctrl-size",t),m("Label","ctrl-label",r),M),B=o("pre",{class:"code-block"}),$=o("div",{class:"code-wrap"},o("h3",{class:"preview-block__title"},"Code"),B);return e.append(H,o("div",{class:"ctrl-stage-wrap"},n,$)),queueMicrotask(l),e}function Ng(){const e=(l,s)=>o("div",{class:"do-card"},o("div",{class:"do-dont-header"},"✓ Do"),o("div",{class:`do-dont-preview${Array.isArray(l)?" do-dont-preview--row":""}`},...Array.isArray(l)?l:[l]),o("p",{},s)),n=(l,s)=>o("div",{class:"dont-card"},o("div",{class:"do-dont-header"},"✗ Don't"),o("div",{class:`do-dont-preview${Array.isArray(l)?" do-dont-preview--row":""}`},...Array.isArray(l)?l:[l]),o("p",{},s));return o("div",{class:"tab-content guidelines-layout"},o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading do-heading"},"Do"),o("p",{class:"preview-block__lede"},"Patterns that strengthen hierarchy and make a button's action obvious."),o("div",{class:"do-dont-grid"},e(v({variant:"primary",label:"Save changes"}),"Use one primary button per view to anchor the most important action."),e(v({label:"Add account",leadingIcon:"+"}),"Pair icons with clear text labels. The icon reinforces meaning without replacing language."),e(v({variant:"destructive",label:"Delete account"}),"For destructive actions, name the consequence in the label."),e([v({variant:"primary",label:"Save"}),v({variant:"secondary",label:"Cancel"})],"Pair a primary action with a secondary, low-emphasis cancel option."))),o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading dont-heading"},"Don't"),o("p",{class:"preview-block__lede"},"Patterns that weaken hierarchy or confuse the user about what an action will do."),o("div",{class:"do-dont-grid"},n([v({variant:"primary",label:"Save"}),v({variant:"primary",label:"Continue"}),v({variant:"primary",label:"Submit"})],"Don't stack multiple primary buttons together — users won't know which action takes precedence."),n(v({label:"Click here to perform the requested action now"}),"Don't write long, vague labels. Use 1–3 word verb phrases."),n(v({variant:"destructive",label:"Yes"}),`Don't use generic confirm-style labels for destructive actions. "Yes" doesn't tell the user what they're destroying.`),n(v({variant:"tertiary",label:"OK",size:"sm"}),"Don't use tertiary buttons for primary actions — there's no visual hierarchy to anchor the user's next step."))))}function Wg(){return o("div",{class:"tab-content guidelines-layout"},o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Writing button labels"),o("p",{class:"preview-block__lede"},"Buttons live or die on their label. A good label tells the user exactly what will happen when they click."),o("ul",{class:"guideline-list"},o("li",{},'Use sentence case ("Save changes", not "Save Changes" or "SAVE CHANGES").'),o("li",{},'Lead with a verb. Buttons describe an action: "Add", "Submit", "Cancel".'),o("li",{},"Keep labels under 3 words when possible. If you need more, you probably need a different component."),o("li",{},'Avoid redundancy. "Save" beats "Save now"; "Cancel" beats "Cancel this action".'),o("li",{},'For destructive actions, name the consequence: "Delete account", not "Yes" or "Confirm".'),o("li",{},`Match the verb tense to the user's intent. "Add" is invitational; "Added" is confirmational and shouldn't live on a button.`))),o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Localization"),o("ul",{class:"guideline-list"},o("li",{},"Reserve at least 30% extra horizontal space for translated strings. German and French labels often run longer than English."),o("li",{},`Don't concatenate fragments to build a label — translate the full string. Avoid: "Add" + " " + entityType.`),o("li",{},"Use the @lit/localize msg() helper to mark labels for translation."))))}function Gg(){return o("div",{class:"tab-content guidelines-layout"},o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Keyboard & focus"),o("ul",{class:"guideline-list"},o("li",{},"Renders as a native <button>. Receives keyboard focus and is activated by Enter and Space."),o("li",{},"Visible focus ring uses a 2px outline at offset 2px on :focus-visible. Never disable focus styles."),o("li",{},"Disabled buttons set the `disabled` attribute and are skipped in tab order."),o("li",{},"No keyboard trap: focus moves naturally to the next focusable element."))),o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Screen readers"),o("ul",{class:"guideline-list"},o("li",{},'Loading buttons set aria-busy="true" so assistive tech announces the state.'),o("li",{},'Icon-only buttons require an aria-label that matches the visual intent ("Close", "Search").'),o("li",{},`Decorative icons inside text buttons set aria-hidden="true" so they're not announced twice.`))),o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Color & motion"),o("ul",{class:"guideline-list"},o("li",{},"Color contrast meets WCAG 2.1 AA against background-page in both light and dark themes."),o("li",{},"Status (info, success, warning, error) is never conveyed by color alone — pair with text or icons."),o("li",{},"Honors prefers-reduced-motion: state transitions and the loading spinner collapse for users who request reduced motion."))))}function Kg(){return o("div",{class:"tab-content guidelines-layout"},o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"HTML / Web Component"),o("pre",{class:"code-block"},`<connex-button variant="primary" size="md">
  Save changes
</connex-button>
...
<Button variant="primary" onClick={save}>
  Save changes
</Button>`)),o("section",{class:"guideline-section"},o("h3",{class:"guideline-heading"},"Props"),o("div",{class:"props-table-wrap"},o("table",{class:"props-table"},o("thead",{},o("tr",{},o("th",{},"Prop"),o("th",{},"Type"),o("th",{},"Default"),o("th",{},"Description"))),o("tbody",{},o("tr",{},o("td",{},"variant"),o("td",{},'"primary" | "secondary" | "tertiary" | "destructive"'),o("td",{},'"primary"'),o("td",{},"Visual hierarchy.")),o("tr",{},o("td",{},"size"),o("td",{},'"sm" | "md" | "lg"'),o("td",{},'"md"'),o("td",{},"Button size.")),o("tr",{},o("td",{},"disabled"),o("td",{},"boolean"),o("td",{},"false"),o("td",{},"Disable interaction.")),o("tr",{},o("td",{},"loading"),o("td",{},"boolean"),o("td",{},"false"),o("td",{},"Show spinner and set aria-busy.")),o("tr",{},o("td",{},"leading-icon"),o("td",{},"string"),o("td",{},"—"),o("td",{},"Hero Icon name placed before the label.")),o("tr",{},o("td",{},"trailing-icon"),o("td",{},"string"),o("td",{},"—"),o("td",{},"Hero Icon name placed after the label.")))))))}{const n=o("div",{class:"foundation-grid"},function(l,s,a){return o("a",{class:"component-link-card",href:`#${l}`},o("h4",{},s),o("p",{},a),o("span",{class:"component-link-card__arrow"},"→"))}("components-button","Button","Primary, secondary, tertiary, destructive variants. Sizes: small, medium, large. Loading and icon states."),f("Input","Text, email, number, password. Native form association. Validation states wired to border-color.error and text-display-error."),f("Modal","Focus-trapped, dismissible, scrim-backed. Uses elevation.4 + motion.duration.slow on enter."),f("Table","Sortable, virtualized, sticky-header. Condensed-density-aware row heights."),f("Tabs","Horizontal and vertical orientations. Keyboard navigation, ARIA tablist semantics."),f("Toast","Stack of dismissible notifications. Status variants (info, success, warning, error). Reduced-motion compliant."));p.append(w("components-overview",y("Components","Reusable Lit Web Components built on Connex tokens. Form-associated via ElementInternals, accessible to WCAG 2.1 AA, framework-agnostic with React wrappers."),n))}p.append(Og("components-button","Button","Triggers an action or navigates to a new view. Buttons are the primary way users interact with Connex products.",[{id:"preview",label:"Preview",content:Fg()},{id:"controls",label:"Controls",content:Rg()},{id:"guidelines",label:"Usage guidelines",content:Ng()},{id:"content",label:"Content",content:Wg()},{id:"accessibility",label:"Accessibility",content:Gg()},{id:"code",label:"Code",content:Kg()}]));{const e=o("div",{class:"foundation-grid"},f("Empty state","Illustration, headline, description, primary action. Used when data is missing or unavailable."),f("Form","Field grouping, inline validation, submission states, error summaries."),f("Workflow stepper","Linear multi-step processes (close account, make payment). Progress indicator and back/next controls."),f("Data table pattern","Toolbar + table + pagination. Filtering, sorting, bulk actions, row selection."));p.append(w("patterns-overview",y("Patterns","Combinations of components that solve recurring UX problems. Cross-product patterns live in core; product-specific patterns live in product repos and can be promoted upward."),e))}{const e=o("div",{class:"foundation-grid"},f("Settings page","Sidebar navigation + scrolling content with section anchors. Used for any preference or configuration UI."),f("Dashboard","Header + stat cards + chart row + activity table. The default landing for product home views."),f("Detail view","Header with key actions, metadata strip, tabbed body. Used for entity pages (customer, account, ticket)."),f("List + filter","Filter sidebar + searchable, sortable list + detail panel. Used for any list-heavy product surface."));p.append(w("templates-overview",y("Templates","Page-level layouts that combine patterns and components. Templates standardize the high-level shape of pages across products."),e))}const F=Array.from(document.querySelectorAll(".nav-group li a")),R=Array.from(document.querySelectorAll(".page")),Yg=new Set(R.map(e=>e.id)),N="foundation-overview";function S(e){var l;const n=Yg.has(e)?e:N;for(const s of R)s.classList.toggle("active",s.id===n);for(const s of F){const a=s.closest("li");a&&a.classList.toggle("active",s.getAttribute("href")===`#${n}`)}(l=document.getElementById("app"))==null||l.scrollTo({top:0}),window.scrollTo({top:0})}function q(){return(location.hash||`#${N}`).slice(1)}for(const e of F)e.addEventListener("click",n=>{const l=e.getAttribute("href")||"";if(!l.startsWith("#"))return;n.preventDefault();const s=l.slice(1);s!==q()&&history.pushState(null,"",`#${s}`),S(s),window.matchMedia("(max-width: 960px)").matches&&document.body.classList.remove("nav-open")});window.addEventListener("hashchange",()=>S(q()));window.addEventListener("popstate",()=>S(q()));S(q());const V=document.getElementById("nav-toggle"),E=document.getElementById("sidebar-scrim"),Xg=window.matchMedia("(max-width: 960px)");function W(e){document.body.classList.toggle("nav-open",e),V==null||V.setAttribute("aria-expanded",String(e))}function I(){W(!1)}V==null||V.addEventListener("click",()=>{W(!document.body.classList.contains("nav-open"))});E==null||E.addEventListener("click",I);Xg.addEventListener("change",e=>{e.matches||I()});document.addEventListener("keydown",e=>{e.key==="Escape"&&document.body.classList.contains("nav-open")&&I()});
//# sourceMappingURL=index-DI0L823I.js.map
