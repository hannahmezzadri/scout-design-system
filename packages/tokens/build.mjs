...
function generateTailwindPreset() {
  ...
  writeFileSync(
    file,
    `// Auto-generated by @scout/tokens build. Do not edit by hand.\n` +
      `// Tailwind preset wired to Scout CSS custom properties.\n` +
      `// Consumers: import preset from '@scout/tokens/tailwind';\n\n` +
...
// Run all builds
console.log('Building Scout tokens...');
await buildBase();
await buildOverlay({
...
await buildOverlay({
  sourceFile: 'src/brand/scout.json',
  selector: '[data-brand="scout"]',
...
console.log('✓ Scout tokens built to dist/');
