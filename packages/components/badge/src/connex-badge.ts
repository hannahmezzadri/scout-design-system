...
/**
 * `<connex-badge>` — small label conveying status, category, or count.
 *
 * @element connex-badge
 *
 ...
 */
@customElement('connex-badge')
export class ConnexBadge extends LitElement {
  static styles = css`
    :host {
      display: inline-flex;
      --_badge-padding-block: 2px;
      --_badge-padding-inline: var(--connex-space-8);
      --_badge-font-size: var(--connex-font-size-12);
      --_badge-line-height: var(--connex-font-line-height-15);
      --_badge-icon-size: 12px;
      --_badge-gap: var(--connex-space-4);
    }
    :host([size='condensed']) {
      --_badge-padding-block: 1px;
      --_badge-padding-inline: var(--connex-space-4);
      --_badge-font-size: var(--connex-font-size-10);
    ...
    :host([type='success']:not([emphasis])) .badge {
      ...
      color: var(--connex-text-display-success);
    }
    ...
    :host([type='ai-summary'][emphasis='high']) .badge {
      background: var(--connex-color-purple-600);
      color: var(--connex-color-white);
    }
    :host([type='ai-summary'][emphasis='low']) .badge,
    :host([type='ai-summary']:not([emphasis])) .badge {
      background: var(--connex-color-purple-100);
      color: var(--connex-color-purple-700);
    }
