...
/**
 * `<connex-notification-badge>` — small visual indicator that draws attention
 ...
 *
 * @element connex-notification-badge
 *
 ...
 */
@customElement('connex-notification-badge')
export class ConnexNotificationBadge extends LitElement {
  static styles = css`
    :host {
      display: inline-flex;
      --_nb-base: var(--connex-color-red-500);
      --_nb-text: var(--connex-color-white);
      --_nb-stroke-w: 2px;
      --_nb-stroke-c: var(--cnx-notification-stroke-color, var(--connex-surface-page));
    }
...
declare global {
  interface HTMLElementTagNameMap {
    'connex-notification-badge': ConnexNotificationBadge;
  }
}
