...
// foundation-overview
{
  ...
  const hero = el('section', { class: 'overview-hero' },
    el('div', { class: 'overview-hero__copy' },
      ...
      el('h2', { class: 'overview-hero__title' }, 'Scout empowers a family of products with a single, cohesive visual and interaction language.'),
      el('p', { class: 'overview-hero__body' },
        'It is built on atomic design methodology and follows a tokens → components → patterns → templates structure. Tokens and components are specific to Scout and form the building blocks of the system. Patterns and templates ship in both core/shared form and product-specific form.'),
...
// --- Components overview
{
  ...
  const components: ComponentEntry[] = [
    ...
    { id: 'components-toggle-switch', name: 'Toggle switch', summary: 'Toggles are used to quickly switch between two states (i.e. On / Off). Default and condensed sizes, optional left or right label, optional on-critical color treatment.' },
  ];
...
app.append(componentPage(
  ...
  'Toggle switch',
  'Toggles are used to quickly switch between two states (i.e. On / Off). Default and condensed sizes, optional left or right label, optional on-critical color treatment for destructive enables.',
  [
